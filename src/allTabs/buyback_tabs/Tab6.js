  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.ipoCard}>
        <View style={styles.ipoHeader}>
          <Image
            ...
            style={styles.logo}
          />
          <Text style={styles.ipoTitle}>Matrimony.com Ltd Buyback</Text>
          <TouchableOpacity>
      ...
      <View style={styles.ipoCard}>
        <View style={styles.ipoHeader}>
          <Image
            source={require("@/assets/cardImages/card-9.jpg")}
            style={styles.logo}
          />
          <Text style={styles.ipoTitle}>Aarti Drugs Ltd. Buyback</Text>
          <TouchableOpacity>
            <Text style={styles.shareText}>Share</Text>
          </TouchableOpacity>
        </View>
      ...
      <View style={styles.ipoCard}>
        <View style={styles.ipoHeader}>
          <Image
            ...
            style={styles.logo}
          />
          <Text style={styles.ipoTitle}>Weizmann Limited Buyback</Text>
          <TouchableOpacity>
            <Text style={styles.shareText}>Share</Text>
          </TouchableOpacity>
        </View>
      ...
      <View style={styles.ipoCard}>
        <View style={styles.ipoHeader}>
          <Image
            source={require("@/assets/cardImages/card-3.png")}
            style={styles.logo}
          />
          <Text style={styles.ipoTitle}>KDDL Ltd Buyback</Text>
          <TouchableOpacity>
            <Text style={styles.shareText}>Share</Text>
          </TouchableOpacity>
        </View>
