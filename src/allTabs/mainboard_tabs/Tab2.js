      ...
      <View style={styles.ipoCard}>
        <View style={styles.ipoHeader}>
          <Image
            ...
            style={styles.logo}
          />
          <Text style={styles.ipoTitle}>Unimech Aerospace & Manufacturing</Text>
          <TouchableOpacity>
            <Text style={styles.shareText}>Share</Text>
          </TouchableOpacity>
        </View>
      ...
      <View style={styles.ipoCard}>
        <View style={styles.ipoHeader}>
          <Image
            ...
            style={styles.logo}
          />
          <Text style={styles.ipoTitle}>Senoras Pharmaceuticals</Text>
          <TouchableOpacity>
            <Text style={styles.shareText}>Share</Text>
          </TouchableOpacity>
        </View>
      ...
      <View style={styles.ipoCard}>
        <View style={styles.ipoHeader}>
          <Image
            ...
            style={styles.logo}
          />
          <Text style={styles.ipoTitle}>Carraro India</Text>
          <TouchableOpacity>
            <Text style={styles.shareText}>Share</Text>
          </TouchableOpacity>
        </View>
